...
fewcloudsnight = pygame.image.load("fewcloudsnight.jpg")
scatteredcloudsday = pygame.image.load("scatteredcloudsday.jpg")
scatteredcloudsnight = pygame.image.load("scatteredcloudsnight.jpg")
brokencloudsday = pygame.image.load("brokencloudsday.jpg")
brokencloudsnight = pygame.image.load("brokencloudsnight.jpg")
rainday = pygame.image.load("rainday.jpg")
rainnight = pygame.image.load("rainnight.jpg")
thunderstormday = pygame.image.load("thunderstormday.jpg")
thunderstormnight = pygame.image.load("thunderstormnight.jpg")
snowday = pygame.image.load("snowday.jpg")
